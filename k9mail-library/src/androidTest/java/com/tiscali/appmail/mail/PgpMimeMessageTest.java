...
public class PgpMimeMessageTest {
    ...
    public void testSignedMessage() throws IOException, MessagingException, PGPException {
        ...
        BinaryTempFileBody
                .setTempDirectory(InstrumentationRegistry.getTargetContext().getCacheDir());
    ...
    private boolean verifySignature(byte[] signedData, byte[] signatureData)
            throws IOException, PGPException {
        InputStream signatureInputStream =
                PGPUtil.getDecoderStream(new ByteArrayInputStream(signatureData));
        ...
        InputStream keyInputStream =
                PGPUtil.getDecoderStream(new ByteArrayInputStream(PUBLIC_KEY.getBytes()));
        PGPPublicKeyRingCollection pgpPublicKeyRingCollection =
                new BcPGPPublicKeyRingCollection(keyInputStream);
