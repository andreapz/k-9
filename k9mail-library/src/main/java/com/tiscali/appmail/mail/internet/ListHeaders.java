 ...
 * Intended to cover:
 *
 * RFC 2369 The Use of URLs as Meta-Syntax for Core Mail List Commands and their Transport through
 * Message Header Fields https://www.ietf.org/rfc/rfc2369.txt
 *
 * This is the following fields:
 *
 * List-Help List-Subscribe List-Unsubscribe List-Post List-Owner List-Archive
 *
