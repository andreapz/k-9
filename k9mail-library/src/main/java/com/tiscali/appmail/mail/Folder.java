...
public abstract class Folder<T extends Message> {
    ...
    // NONE is obsolete, it will be translated to NO_CLASS for display and to INHERITED for sync and
    // push
    public enum FolderClass {
        NONE, NO_CLASS, INHERITED
    }
    ...
    /**
     * Forces an open of the MailProvider. If the provider is already open this function returns
    ...
    /**
     * Forces a close of the MailProvider. Any further access will attempt to reopen the
     * MailProvider.
     */
    ...
    /**
     * Get the mode the folder was opened with. This may be different than the mode the open was
     * requested with.
     * 
     * @return
     */
    ...
    /**
     * Create a new folder with a specified display limit. Not abstract to allow remote folders to
     * not override or worry about this call if they don't care to.
     */
     ...
     */
    public abstract List<T> getMessages(int start, int end, Date earliestDate,
    ...
    /**
     * Populate a list of messages based upon a FetchProfile. See {@link FetchProfile} for the
     * things that can be fetched.
     * 
    ...
    public List<T> search(String queryString, final Set<Flag> requiredFlags,
