...
public abstract class Message implements Part, Body {
     ...
     * @param set If <code>true</code>, the flag is added. If <code>false</code> , the flag is
     *        removed.
     ...
     * {@code ConcurrentModificationException}s. It shouldn't be used unless absolutely necessary.
     * See the comment in
     * {@link com.tiscali.appmail.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(com.tiscali.appmail.Account, String, String, Message)}
