...
class DataSet {
    ...
    public void finish() {
        ...
        if (mTempData != null) {
            ...
            /*
             * Lost Data are for requests that don't include a message UID. These requests should
             * only have a depth of one for the response so it will never get stomped over.
             */
        }
            ...
            if (data != null) {
                for (Map.Entry<String, String> entry : data.entrySet()) {
                    ...
                    if (header.equals("read")) {
                        ...
                        /**
                         * Exchange doesn't give us rfc822 dates like it claims. The date is in the
                         * format: yyyy-MM-dd'T'HH:mm:ss.SSS<Single digit representation of
                         * timezone, so far, all instances are Z>
                         */
                        ...
                        try {
                            ...
                            Log.e(LOG_TAG, "Error parsing date: " + pe + "\nTrace: "
                                    + WebDavUtils.processException(pe));
                        }
