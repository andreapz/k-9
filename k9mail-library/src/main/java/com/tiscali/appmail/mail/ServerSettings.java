 ...
 * </p>
 *
 * @see com.tiscali.appmail.mail.store.StoreConfig#getStoreUri()
...
public class ServerSettings {
    ...
    public enum Type {
        ...
        IMAP(143, 993), SMTP(587, 465), WebDAV(80, 443), POP3(110, 995);

        public final int defaultPort;

        /**
         * Note: port for connections using TLS (=SSL) immediately from the initial TCP connection.
         *
    ...
    /**
     * The alias to retrieve a client certificate using Android 4.0 KeyChain API for TLS client
     * certificate authentication with the server.
     *
     * {@code null} if not applicable for the store or transport.
     */
     ...
     */
    public ServerSettings(Type type, String host, int port, ConnectionSecurity connectionSecurity,
    ...
    public ServerSettings newClientCertificateAlias(String newAlias) {
        return new ServerSettings(type, host, port, connectionSecurity, AuthType.EXTERNAL, username,
                password, newAlias);
    }
}
