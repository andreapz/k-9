/*
 * Copyright (C) 2012 The K-9 Dog Walkers Copyright (C) 2011 The Android Open Source Project
 *
...
class ImapUtility {
     ...
     *
     * @return The list of IDs as strings in this sequence set. If the set is invalid, an empty list
     *         is returned.
     */
     ...
     *
     * @return The list of IDs as strings in this range. If the range is not valid, an empty list is
     *         returned.
     */
     ...
     *
     * "A quoted string is a sequence of zero or more 7-bit characters, excluding CR and LF, with
     * double quote (<">) characters at each end." - Section 4.3, RFC 3501
     *
