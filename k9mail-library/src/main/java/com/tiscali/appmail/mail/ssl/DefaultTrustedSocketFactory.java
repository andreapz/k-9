...
public class DefaultTrustedSocketFactory implements TrustedSocketFactory {
    ...
    protected static final String[] ORDERED_KNOWN_CIPHERS = {
            ...
            "TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA", "TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA",
            "TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA", "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA",
            "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA", "TLS_DHE_RSA_WITH_AES_128_CBC_SHA",
            "TLS_DHE_DSS_WITH_AES_128_CBC_SHA", "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA",
    ...
    protected static final String[] BLACKLISTED_CIPHERS =
            {"SSL_RSA_WITH_DES_CBC_SHA", "SSL_DHE_RSA_WITH_DES_CBC_SHA",
                    ...
                    "SSL_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA", "SSL_RSA_WITH_3DES_EDE_CBC_SHA",
    ...
    protected static final String[] ORDERED_KNOWN_PROTOCOLS = {"TLSv1.2", "TLSv1.1", "TLSv1"};

    protected static final String[] BLACKLISTED_PROTOCOLS = {"SSLv3"};
    ...
    static {
        ...
        try {
            ...
            /*
             * Retrieve all supported protocols, not just the (default) enabled ones. TLSv1.1 &
             * TLSv1.2 are supported on API levels 16+, but are only enabled by default on API
             * levels 20+.
             */
            supportedProtocols = sock.getSupportedProtocols();
        } catch (Exception e) {
            Log.e(LOG_TAG,
                    "Error getting information about available SSL/TLS ciphers and " + "protocols",
                    e);
        }
    ...
    public Socket createSocket(Socket socket, String host, int port, String clientCertificateAlias)
        ...
        if (!TextUtils.isEmpty(clientCertificateAlias)) {
            keyManagers =
                    new KeyManager[] {new KeyChainKeyManager(context, clientCertificateAlias)};
        }
