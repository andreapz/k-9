...
import com.tiscali.appmail.mail.ssl.TrustManagerFactory;


/*
 * TODO: find out what's going on here and document it. Using two socket factories looks suspicious.
 */
public class WebDavSocketFactory implements LayeredSocketFactory {
    ...
    public Socket connectSocket(Socket sock, String host, int port, InetAddress localAddress,
            int localPort, HttpParams params) throws IOException, ConnectTimeoutException {
        return mSchemeSocketFactory.connectSocket(sock, host, port, localAddress, localPort,
                params);
    }
    ...
    public Socket createSocket(final Socket socket, final String host, final int port,
        ...
        SSLSocket sslSocket =
                (SSLSocket) mSocketFactory.createSocket(socket, host, port, autoClose);
