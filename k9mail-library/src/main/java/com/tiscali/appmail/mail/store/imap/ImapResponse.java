 ...
 *
 * <p>
 * Tagged responses will have a non-null tag. Untagged responses will have a null tag. The object
 * will contain all of the available tokens at the time the response is received.
 * </p>
 */
class ImapResponse extends ImapList {
    ...
    private ImapResponse(ImapResponseCallback callback, boolean commandContinuationRequested,
            String tag) {
