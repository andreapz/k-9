...
class JisSupport {
    ...
    public static String getJisVariantFromMessage(Message message) throws MessagingException {
        ...
        // If a receiver is known to use a JIS variant, the sender transfers the message after
        // converting the
        ...
        // If a receiver is not known to use any JIS variants, the sender transfers the message
        // without converting
        // the charset.
