...
public class FetchProfile extends ArrayList<FetchProfile.Item> {
    ...
    /**
     * Default items available for pre-fetching. It should be expected that any item fetched by
     * using these items could potentially include all of the previous items.
     */
    public enum Item {
        /**
        ...
        /**
         * Download the structure of the message. This maps directly to IMAP's BODYSTRUCTURE and may
         * map to other providers. The provider should, if possible, fill in a properly formatted
         * MIME structure in the message without actually downloading any message data. If the
         * provider is not capable of this operation it should specifically set the body of the
         * message to null so that upper levels can detect that a full body download is needed.
         */
        STRUCTURE,

        /**
         * A sane portion of the entire message, cut off at a provider determined limit. This should
         * generaly be around 50kB.
         */
        BODY_SANE,
