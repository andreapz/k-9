...
import static com.tiscali.appmail.mail.internet.JisSupport.SHIFT_JIS;
...
public class CharsetSupport {
    ...
    static String readToString(InputStream in, String charset) throws IOException {
        ...
        /*
         * See if there is conversion from the MIME charset to the Java one. this function may also
         * throw an exception if the charset name is not known
         */
        boolean supported;
        try {
