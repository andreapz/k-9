 ...
 * <p>
 * The default behaviour of the Base64OutputStream is to ENCODE, whereas the default behaviour of
 * the Base64InputStream is to DECODE. But this behaviour can be overridden by using a different
 * constructor.
 * </p>
 * <p>
...
public class Base64OutputStream extends FilterOutputStream {
     ...
     *        characters. If lineLength <=0, the encoded data is not divided into lines. If doEncode
     ...
     * stream. If propogate is true, the wrapped stream will also be flushed.
     *
     * @param propogate boolean flag to indicate whether the wrapped OutputStream should also be
     *        flushed.
     * @throws IOException if an I/O error occurs.
     */
    ...
    /**
     * Closes this output stream, flushing any remaining bytes that must be encoded. The underlying
