...
public class ImapStoreSettings extends ServerSettings {
    ...
    protected ImapStoreSettings(String host, int port, ConnectionSecurity connectionSecurity,
            ...
            String clientCertificateAlias, boolean autodetectNamespace, String pathPrefix) {

        super(Type.IMAP, host, port, connectionSecurity, authenticationType, username, password,
    ...
    public ServerSettings newPassword(String newPassword) {
        return new ImapStoreSettings(host, port, connectionSecurity, authenticationType, username,
                newPassword, clientCertificateAlias, autoDetectNamespace, pathPrefix);
    }
}
