package com.tiscali.appmail.mail.store.imap.mockserver;
...
public class MockImapServer {
    ...
    public void verifyInteractionCompleted() {
        ...
        UnexpectedCommandException unexpectedCommandException =
                mockServerThread.getUnexpectedCommandException();
        if (unexpectedCommandException != null) {
            throw new AssertionError(unexpectedCommandException.getMessage(),
    ...
    private static class MockServerThread extends Thread {
        ...
        private void readExpectedCommand(ExpectedCommand expectedCommand)
                throws IOException, UnexpectedCommandException {
        ...
        private void upgradeToTls(Socket socket)
