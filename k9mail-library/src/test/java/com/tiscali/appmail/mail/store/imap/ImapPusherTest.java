...
public class ImapPusherTest {
    ...
    @Test
    public void start_withSingleFolderName_shouldCreateImapFolderPusherAndCallStartOnIt()
            throws Exception {
        List<String> folderNames = Collections.singletonList("INBOX");
    ...
    @Test
    public void start_withTwoFolderNames_shouldCreateTwoImapFolderPushersAndCallStart()
            throws Exception {
    ...
    @Test
    public void stop_withoutStartBeingCalled_shouldNotCreateAnyImapFolderPushers()
            throws Exception {
        imapPusher.stop();
