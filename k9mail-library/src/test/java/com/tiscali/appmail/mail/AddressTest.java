...
public class AddressTest {
    /**
     * test the possibility to parse "From:" fields with no email. for example: From: News for
     * Vector Limited - Google Finance http://code.google.com/p/k9mail/issues/detail?id=3814
     */
    @Test
    ...
    public void testParseUnusualEmails() {
        String[] testEmails = new String[] {"prettyandsimple@example.com",
                 ...
                 * "\" \"@example.org",
                 */
                "admin@mailserver1", "#!$%&'*+-/=?^_`{}|~@example.org", "example@localhost",
                "example@s.solutions", "user@com", "user@localserver", "user@[IPv6:2001:db8::1]"};
