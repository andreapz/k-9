...
import com.tiscali.appmail.mail.internet.BinaryTempFileMessageBody;
...
public class MessageTest {
    ...
    private static final String SEVEN_BIT_RESULT = "From: from@example.com\r\n"
    ...
    private MimeMessage nestedMessage(MimeMessage subMessage)
        ...
        BinaryTempFileMessageBody tempMessageBody =
                new BinaryTempFileMessageBody(MimeUtil.ENC_8BIT);
