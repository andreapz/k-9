...
import static com.tiscali.appmail.message.MessageCreationHelper.createEmptyPart;
import static com.tiscali.appmail.message.MessageCreationHelper.createMultipart;
import static com.tiscali.appmail.message.MessageCreationHelper.createPart;
import static com.tiscali.appmail.message.MessageCreationHelper.createTextPart;
...
public class TextPartFinderTest {
    ...
    @Test
    public void findFirstTextPart_withMultipartAlternativeContainingOnlyTextHtmlPart()
            throws Exception {
        BodyPart expected = createTextPart("text/html");
        Part part = createMultipart("multipart/alternative", createPart("image/gif"), expected,
    ...
    public void findFirstTextPart_withMultipartAlternativeNotContainingTextPart() throws Exception {
        Part part = createMultipart("multipart/alternative", createPart("image/gif"),
    ...
    public void findFirstTextPart_withMultipartAlternativeContainingMultipartRelatedContainingTextHtmlFirst()
            throws Exception {
        BodyPart expected = createTextPart("text/plain");
        Part part = createMultipart("multipart/alternative", createMultipart("multipart/related",
                createTextPart("text/html"), createPart("image/jpeg")), expected);
    ...
    public void findFirstTextPart_withMultipartMixedNotContainingTextPart() throws Exception {
        Part part = createMultipart("multipart/mixed", createPart("image/jpeg"),
    ...
    @Test
    public void findFirstTextPart_withMultipartMixedContainingMultipartAlternative()
            throws Exception {
        BodyPart expected = createTextPart("text/plain");
        Part part = createMultipart("multipart/mixed", createPart("image/jpeg"),
