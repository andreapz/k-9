...
import com.tiscali.appmail.K9.LockScreenNotificationVisibility;
...
public class LockScreenNotificationTest {
    ...
    public void configureLockScreenNotification_SENDERS_withMultipleMessages() throws Exception {
        ...
        NotificationContent content3 =
                createNotificationContent("\"Peter Lustig\" <peter@example.com>");
        ...
        when(notificationData.getContentForSummaryNotification())
                .thenReturn(Arrays.asList(content1, content2, content3));
    ...
    public void configureLockScreenNotification_SENDERS_makeSureWeGetEnoughSenderNames()
            throws Exception {
        assertTrue(
                NotificationData.MAX_NUMBER_OF_MESSAGES_FOR_SUMMARY_NOTIFICATION >= LockScreenNotification.MAX_NUMBER_OF_SENDERS_IN_LOCK_SCREEN_NOTIFICATION);
    }
