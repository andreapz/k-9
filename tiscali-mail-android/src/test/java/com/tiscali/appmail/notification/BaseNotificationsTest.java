...
public class BaseNotificationsTest {
    ...
    public void testCreateBigTextStyleNotification() throws Exception {
        ...
        Builder builder =
                notifications.createBigTextStyleNotification(account, holder, notificationId);
    ...
    private NotificationHolder createNotificationHolder(int notificationId) {
        NotificationContent content = new NotificationContent(null, SENDER, SUBJECT,
                NOTIFICATION_PREVIEW, NOTIFICATION_SUMMARY, false);
    ...
    static class TestNotifications extends BaseNotifications {
        ...
        protected TestNotifications(NotificationController controller,
