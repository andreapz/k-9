...
import com.tiscali.appmail.MockHelper;
...
public class WearNotificationsTest {
    ...
    public void setUp() throws Exception {
        ...
        NotificationController controller =
                createNotificationController(RuntimeEnvironment.application, builder);
        MessagingController messagingController = createMessagingController();

        wearNotifications =
                new TestWearNotifications(controller, actionCreator, messagingController);
    }
    ...
    public void testBuildStackedNotification() throws Exception {
        ...
        when(actionCreator.createReplyPendingIntent(messageReference, notificationId))
        ...
        verifyAddAction(R.drawable.ic_action_single_message_options_dark, "Reply",
                replyPendingIntent);
        verifyAddAction(R.drawable.ic_action_mark_as_read_dark, "Mark Read",
    ...
    public void testAddSummaryActions() throws Exception {
        ...
        when(actionCreator.getMarkAllAsReadPendingIntent(account, messageReferences,
                notificationId)).thenReturn(markAllAsReadPendingIntent);

        wearNotifications.addSummaryActions(builder, notificationData);

        verifyExtendWasOnlyCalledOnce();
        verifyAddAction(R.drawable.ic_action_mark_as_read_dark, "Mark All Read",
    ...
    public void testAddSummaryActionsWithArchiveAllActionEnabled() throws Exception {
        ...
        NotificationData notificationData = createNotificationData(messageReferences);
        PendingIntent archivePendingIntent = createFakePendingIntent(1);
        when(actionCreator.createArchiveAllPendingIntent(account, messageReferences,
                notificationId)).thenReturn(archivePendingIntent);
    ...
    static class ActionMatcher extends ArgumentMatcher<WearableExtender> {
        ...
        public boolean matches(Object argument) {
            ...
            for (Action action : wearableExtender.getActions()) {
                if (action.icon == icon && action.title.equals(title)
    ...
    static class TestWearNotifications extends WearNotifications {
        ...
        public TestWearNotifications(NotificationController controller,
                NotificationActionCreator actionCreator, MessagingController messagingController) {
