...
public class NewMailNotificationsTest {
    ...
    public void setUp() throws Exception {
        ...
        newMailNotifications = new TestNewMailNotifications(controller, contentCreator,
                deviceNotifications, wearNotifications);
    }
    ...
    public void testAddNewMailNotification() throws Exception {
        ...
        int wearNotificationId =
                NotificationIds.getNewMailStackedNotificationId(account, notificationIndex);
    ...
    public void testAddNewMailNotificationWithPrivacyModeEnabled() throws Exception {
        ...
        int wearNotificationId =
                NotificationIds.getNewMailStackedNotificationId(account, notificationIndex);
        int summaryNotificationId = NotificationIds.getNewMailSummaryNotificationId(account);
        verify(notificationManager, never()).notify(eq(wearNotificationId),
    ...
    public void testAddNewMailNotificationTwice() throws Exception {
        ...
        int wearNotificationIdOne =
                NotificationIds.getNewMailStackedNotificationId(account, notificationIndexOne);
        int wearNotificationIdTwo =
                NotificationIds.getNewMailStackedNotificationId(account, notificationIndexTwo);
        int summaryNotificationId = NotificationIds.getNewMailSummaryNotificationId(account);
    ...
    public void testRemoveNewMailNotification() throws Exception {
        ...
        addToDeviceNotifications(summaryNotification);
        newMailNotifications.addNewMailNotification(account, message, 23);
        whenRemovingContentReturn(messageReference,
    ...
    public void testRemoveNewMailNotificationWithCreateNotification() throws Exception {
        ...
        newMailNotifications.addNewMailNotification(account, message, 23);
        whenRemovingContentReturn(messageReference,
                RemoveNotificationResult.createNotification(holderTwo));
    ...
    public void testClearNewMailNotifications() throws Exception {
        ...
        verify(notificationManager)
                .cancel(NotificationIds.getNewMailSummaryNotificationId(account));
    }
    ...
    private void addToNotificationContentCreator(LocalMessage message,
    ...
    private void addToDeviceNotifications(Notification notificationToReturn) {
        when(deviceNotifications.buildSummaryNotification(eq(account),
                eq(newMailNotifications.notificationData), anyBoolean()))
    ...
    private void addToWearNotifications(NotificationHolder notificationHolder,
            Notification notificationToReturn) {
        when(wearNotifications.buildStackedNotification(account, notificationHolder))
                .thenReturn(notificationToReturn);
    }

    private void whenAddingContentReturn(NotificationContent content,
            AddNotificationResult result) {
    ...
    private void whenRemovingContentReturn(MessageReference messageReference,
    ...
    static class TestNewMailNotifications extends NewMailNotifications {
        ...
        TestNewMailNotifications(NotificationController controller,
                NotificationContentCreator contentCreator, DeviceNotifications deviceNotifications,
