...
import static com.tiscali.appmail.MockHelper.mockBuilder;
...
public class DeviceNotificationsTest {
    ...
    private NotificationData createFakeNotificationData(Account account) {
        ...
        NotificationContent content =
                new NotificationContent(null, SENDER, SUBJECT, PREVIEW, SUMMARY, false);
        NotificationContent content2 =
                new NotificationContent(null, SENDER_2, SUBJECT_2, PREVIEW_2, SUMMARY_2, true);
    ...
    private TestDeviceNotifications createDeviceNotifications(Builder builder,
        ...
        return new TestDeviceNotifications(controller, actionCreator, lockScreenNotification,
                wearNotifications);
    }
    ...
    static class TestDeviceNotifications extends DeviceNotifications {
        ...
        TestDeviceNotifications(NotificationController controller,
