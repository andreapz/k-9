...
import com.tiscali.appmail.Account.FolderMode;
import com.tiscali.appmail.Account.MessageFormat;
import com.tiscali.appmail.Account.QuoteStyle;
import com.tiscali.appmail.Account.Searchable;
import com.tiscali.appmail.Account.ShowPictures;
...
import com.tiscali.appmail.preferences.Settings.StringSetting;
...
public class AccountSettings {
    ...
    static {
        ...
        s.put("deletePolicy",
                Settings.versions(new V(1, new DeletePolicySetting(DeletePolicy.NEVER))));
        s.put("displayCount",
                Settings.versions(new V(1, new IntegerResourceSetting(K9.DEFAULT_VISIBLE_LIMIT,
        ...
        // imported from Tiscali Mail
        s.put("folderDisplayMode", Settings
                .versions(new V(1, new EnumSetting<FolderMode>(FolderMode.class, FolderMode.ALL))));
        s.put("folderPushMode", Settings
                .versions(new V(1, new EnumSetting<FolderMode>(FolderMode.class, FolderMode.ALL))));
        s.put("folderSyncMode", Settings
                .versions(new V(1, new EnumSetting<FolderMode>(FolderMode.class, FolderMode.ALL))));
        s.put("folderTargetMode", Settings
                .versions(new V(1, new EnumSetting<FolderMode>(FolderMode.class, FolderMode.ALL))));
        ...
        s.put("maximumAutoDownloadMessageSize",
                Settings.versions(new V(1, new IntegerResourceSetting(32768,
                        R.array.account_settings_autodownload_message_size_values))));
        s.put("maximumPolledMessageAge", Settings.versions(new V(1,
                new IntegerResourceSetting(-1, R.array.account_settings_message_age_values))));
        s.put("messageFormat",
                Settings.versions(new V(1, new EnumSetting<MessageFormat>(MessageFormat.class,
                        Account.DEFAULT_MESSAGE_FORMAT))));
        s.put("messageFormatAuto", Settings
                .versions(new V(2, new BooleanSetting(Account.DEFAULT_MESSAGE_FORMAT_AUTO))));
        s.put("messageReadReceipt", Settings
                .versions(new V(1, new BooleanSetting(Account.DEFAULT_MESSAGE_READ_RECEIPT))));
        ...
        s.put("quotePrefix",
                Settings.versions(new V(1, new StringSetting(Account.DEFAULT_QUOTE_PREFIX))));
        s.put("quoteStyle", Settings.versions(new V(1,
                new EnumSetting<QuoteStyle>(QuoteStyle.class, Account.DEFAULT_QUOTE_STYLE))));
        s.put("replyAfterQuote",
                Settings.versions(new V(1, new BooleanSetting(Account.DEFAULT_REPLY_AFTER_QUOTE))));
        ...
        s.put("searchableFolders", Settings
                .versions(new V(1, new EnumSetting<Searchable>(Searchable.class, Searchable.ALL))));
        ...
        s.put("showPicturesEnum", Settings.versions(
                new V(1, new EnumSetting<ShowPictures>(ShowPictures.class, ShowPictures.NEVER))));
        ...
        s.put("stripSignature",
                Settings.versions(new V(2, new BooleanSetting(Account.DEFAULT_STRIP_SIGNATURE))));
        ...
        s.put("vibratePattern", Settings.versions(new V(1,
                new IntegerResourceSetting(0, R.array.account_settings_vibrate_pattern_values))));
        s.put("vibrateTimes", Settings.versions(new V(1,
                new IntegerResourceSetting(5, R.array.account_settings_vibrate_times_label))));
        s.put("allowRemoteSearch", Settings.versions(new V(18, new BooleanSetting(true))));
        s.put("remoteSearchNumResults",
                Settings.versions(new V(18,
                        new IntegerResourceSetting(Account.DEFAULT_REMOTE_SEARCH_NUM_RESULTS,
        ...
        s.put("notifyContactsMailOnly", Settings.versions(new V(42, new BooleanSetting(false))));
