package com.tiscali.appmail.adapter;
...
import com.tiscali.appmail.model.NavDrawerMenuItem;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            if (item.getIconUrl() != null) {
                ...
                Glide.with(mContext).load(item.getIconUrl()).into(itemViewHolder.mItemIconIv);
            ...
            itemViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (hasChildren(position)) {
                        // update status for expandable item (if opened set to close, and vice
                        // versa)
                        ...
                        if (newStatus) { // expandable item just opened
                            ...
                            // remove all elements with depth > item depth (consider nested
                            // children)
