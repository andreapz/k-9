...
public class Preferences {
    ...
    /**
     * Returns an array of the accounts on the system. If no accounts are registered the method
    ...
    /**
     * Returns the Account marked as default. If no account is marked as default the first account
     * in the list is marked as default and then returned. If there are no accounts on the system
    ...
    public static <T extends Enum<T>> T getEnumStringPref(Storage storage, String key,
            T defaultEnum) {
        ...
        if (stringPref == null) {
            ...
            try {
                ...
                Log.w(K9.LOG_TAG, "Unable to convert preference key [" + key + "] value ["
                        + stringPref + "] to enum of type " + defaultEnum.getDeclaringClass(), ex);
