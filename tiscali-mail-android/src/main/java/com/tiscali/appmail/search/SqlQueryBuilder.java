...
public class SqlQueryBuilder {
        ...
        if (node.mLeft == null && node.mRight == null) {
            ...
            switch (condition.field) {
                ...
                case MESSAGE_CONTENTS: {
                    ...
                    query.append(
                            "(EXISTS (SELECT docid FROM messages_fulltext WHERE docid = id AND fulltext MATCH ?))");
    ...
    public static String addPrefixToSelection(String[] columnNames, String prefix,
            String selection) {
