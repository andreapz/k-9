 ...
 * This is a meta-account containing all the e-mail that matches the search.
 */
public class SearchAccount implements BaseAccount {
     ...
     *
     * <p>
     * This isn't really a UUID. But since we don't expose this value to other apps and we only use
     * the account UUID as opaque string (e.g. as key in a {@code Map}) we're fine.<br>
