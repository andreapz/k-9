 ...
 *
 * TODO implement a complete addAllowedFolder method TODO conflicting conditions check on add TODO
 * duplicate condition checking? TODO assign each node a unique id that's used to retrieve it from
 * the leaveset and remove.
 *
 */
...
public class LocalSearch implements SearchSpecification {
    ...
    /**
     * Add a new account to the search. When no accounts are added manually we search all accounts
     * on the device.
     *
    ...
    /**
     * Adds all the account uuids in the provided array to be matched by the seach.
     *
     * @param accountUuids
     */
    ...
    /**
     * Adds the provided condition as the second argument of an AND clause to this node.
     *
     ...
     *
     * Add the folder as another folder to search in. The folder will be added AND to the root if no
     * 'folder subtree' was found. Otherwise the folder will be added OR to that tree.
     *
     * @param name Name of the folder to add.
     */
    public void addAllowedFolder(String name) {
        /*
         * TODO find folder sub-tree - do and on root of it & rest of search - do or between folder
         * nodes
         */
    ...
    /*
     * TODO make this more advanced! This is a temporarely solution that does NOT WORK for real
     * searches because of possible extra conditions to a folder requirement.
     */
