 ...
 *
 * When {@link #onEvent()} is called, it calls the callback in a certain timeout later. Initially
 * {@link #mMinTimeout} is used as the timeout, but if it gets multiple {@link #onEvent} calls in a
 * certain amount of time, it extends the timeout, until it reaches {@link #mMaxTimeout}.
 *
