...
class NotificationIds {
    ...
    private static final int NUMBER_OF_STACKED_NOTIFICATIONS =
            NotificationData.MAX_NUMBER_OF_STACKED_NOTIFICATIONS;
    ...
    public static int getCertificateErrorNotificationId(Account account, boolean incoming) {
        int offset =
                incoming ? OFFSET_CERTIFICATE_ERROR_INCOMING : OFFSET_CERTIFICATE_ERROR_OUTGOING;
    ...
    public static int getAuthenticationErrorNotificationId(Account account, boolean incoming) {
        int offset = incoming ? OFFSET_AUTHENTICATION_ERROR_INCOMING
