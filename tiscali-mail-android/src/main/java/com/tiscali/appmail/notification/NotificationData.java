...
class NotificationData {
    // Note: As of Jellybean, phone notifications show a maximum of 5 lines, while tablet
    // notifications show 7 lines.
    static final int MAX_NUMBER_OF_MESSAGES_FOR_SUMMARY_NOTIFICATION = 5;
    // Note: This class assumes MAX_NUMBER_OF_STACKED_NOTIFICATIONS >=
    // MAX_NUMBER_OF_MESSAGES_FOR_SUMMARY_NOTIFICATION
    ...
    private final LinkedList<NotificationHolder> activeNotifications =
            new LinkedList<NotificationHolder>();
    private final Deque<NotificationContent> additionalNotifications =
            new LinkedList<NotificationContent>();
    ...
    public List<NotificationContent> getContentForSummaryNotification() {
        ...
        while (iterator.hasNext()
                && notificationCount < MAX_NUMBER_OF_MESSAGES_FOR_SUMMARY_NOTIFICATION) {
    ...
    private int calculateNumberOfMessagesForSummaryNotification() {
        return Math.min(activeNotifications.size(),
                MAX_NUMBER_OF_MESSAGES_FOR_SUMMARY_NOTIFICATION);
    }
    ...
    public RemoveNotificationResult removeNotificationForMessage(
