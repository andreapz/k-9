...
import com.tiscali.appmail.helper.ExceptionHelper;
...
class SendFailedNotifications {
    ...
    public SendFailedNotifications(NotificationController controller,
    ...
    public void showSendFailedNotification(Account account, Exception exception) {
        ...
        PendingIntent folderListPendingIntent =
                actionBuilder.createViewFolderListPendingIntent(account, notificationId);

        NotificationCompat.Builder builder = controller.createNotificationBuilder()
                .setSmallIcon(getSendFailedNotificationIcon()).setWhen(System.currentTimeMillis())
