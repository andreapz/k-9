...
import com.tiscali.appmail.utility.TiscaliConfigRemote;
import com.tiscali.appmail.utility.common.TiscaliOnTaskCompleted;
 ...
 *
 */
public class TiscaliWebtrekk implements TiscaliOnTaskCompleted {
    ...
    public static void startSession(Context context) {
        ...
        Webtrekk.setLoggingEnabled(
                Boolean.parseBoolean(context.getString(R.string.webtrekk_adv_logging_tiscali)));// optional
                                                                                                // debugging
    ...
    @Override
    public void tiscaliOnTaskCompleted(ArrayList<HashMap> results) {}
}
