/*
 * Copyright (C) 2012 The K-9 Dog Walkers Copyright (C) 2006 The Android Open Source Project
 *
...
public class MergeCursor implements Cursor {
     ...
     * Constructor
     *
     * @param cursors The list of cursors this {@code MultiCursor} should combine.
     * @param comparator A comparator that is used to decide in what order the individual cursors
     *        are merged.
     */
