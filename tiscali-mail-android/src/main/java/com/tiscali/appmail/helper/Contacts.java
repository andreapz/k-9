...
public class Contacts {
    /**
     * The order in which the search results are returned by {@link #getContactByAddress(String)}.
     */
    ...
    protected static final String PROJECTION[] =
            {ContactsContract.CommonDataKinds.Email._ID, ContactsContract.Contacts.DISPLAY_NAME,
                    ContactsContract.CommonDataKinds.Email.CONTACT_ID};

    /**
     * Index of the name field in the projection. This must match the order in {@link #PROJECTION}.
     */
     ...
     *
     * <p>
     * Note: This is left over from the days when we needed to have SDK-specific code to access the
     * contacts.
     * </p>
     *
    ...
    /**
     * Start the activity to add information to an existing contact or add a new one.
     *
     * @param email An {@link Address} instance containing the email address of the entity you want
     *        to add to the contacts. Optionally the instance also contains the (display) name of
     *        that entity.
     */
    public void createContact(final Address email) {
        ...
        contactIntent.putExtra(ContactsContract.Intents.EXTRA_CREATE_DESCRIPTION, email.toString());
     ...
     *
     * @param phoneNumber The phone number to add to a contact, or to use when creating a new
     *        contact.
     */
     ...
     * @return <tt>true</tt>, if the email address belongs to a contact. <tt>false</tt>, otherwise.
     */
     ...
     * @return <tt>true</tt>, if one address belongs to a contact. <tt>false</tt>, otherwise.
     */
     ...
     * @return The name of the contact the email address belongs to. Or <tt>null</tt> if there's no
     *         matching contact.
     */
     ...
     *
     * @param addresses Array of {@link Address} objects describing the contacts to be marked as
     *        contacted.
     */
     ...
     *
     * @param address An email address. The contact database is searched for a contact with this
     *        email address.
     *
     * @return URI to the picture of the contact with the supplied email address. {@code null} if no
     *         such contact could be found or the contact doesn't have a picture.
     */
    public Uri getPhotoUri(String address) {
        ...
        try {
            ...
            Cursor cur = mContentResolver.query(ContactsContract.Data.CONTENT_URI, null,
    ...
    /**
     * Return a {@link Cursor} instance that can be used to fetch information about the contact with
     * the given email address.
     *
     * @param address The email address to search for.
     * @return A {@link Cursor} instance that can be used to fetch information about the contact
     *         with the given email address
     */
    private Cursor getContactByAddress(final String address) {
        final Uri uri = Uri.withAppendedPath(
                ContactsContract.CommonDataKinds.Email.CONTENT_LOOKUP_URI, Uri.encode(address));
