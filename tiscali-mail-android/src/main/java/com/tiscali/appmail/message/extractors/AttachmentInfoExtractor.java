...
public class AttachmentInfoExtractor {
    ...
    protected Uri getDecryptedFileProviderUri(DeferredFileBody decryptedTempFileBody,
        ...
        try {
            ...
            uri = DecryptedFileProvider.getUriForProvidedFile(context, file,
                    decryptedTempFileBody.getEncoding(), mimeType);
        } catch (IOException e) {
    ...
    public AttachmentViewInfo extractAttachmentInfoForDatabase(Part part)
            throws MessagingException {
    ...
    @WorkerThread
    private AttachmentViewInfo extractAttachmentInfo(Part part, Uri uri, long size,
            boolean isContentAvailable) throws MessagingException {
