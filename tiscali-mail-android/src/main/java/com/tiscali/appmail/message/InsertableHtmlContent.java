...
/**
 * <p>
 * Represents an HTML document with an insertion point for placing a reply. The quoted document may
 * have been modified to make it suitable for insertion. The modified quoted document should be used
 ...
 * </p>
 *
 * TODO: This container should also have a text part, along with its insertion point. Or maybe a
 * generic InsertableContent and maintain one each for Html and Text?
 */
public class InsertableHtmlContent implements Serializable {
     ...
     *
     * <p>
     * Subsequent calls to {@link #insertIntoQuotedHeader(String)} will <b>prepend</b> text onto any
     ...
     *
     * <p>
     * Subsequent calls to {@link #insertIntoQuotedFooter(String)} will <b>append</b> text onto any
    ...
    public String toDebugString() {
        return "InsertableHtmlContent{" + "headerInsertionPoint=" + headerInsertionPoint
                + ", footerInsertionPoint=" + footerInsertionPoint + ", insertionLocation="
                + insertionLocation + ", quotedContent=" + quotedContent + ", userContent="
                + userContent + ", compiledResult=" + toString() + '}';
    }
}
