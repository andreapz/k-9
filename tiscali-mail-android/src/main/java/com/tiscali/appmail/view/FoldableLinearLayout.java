...
/**
 * Class representing a LinearLayout that can fold and hide it's content when pressed To use just
 * add the following to your xml layout
 * <com.tiscali.appmail.view.FoldableLinearLayout android:layout_width="wrap_content"
 * android:layout_height="wrap_content" custom:foldedLabel="@string/TEXT_TO_DISPLAY_WHEN_FOLDED"
 * custom:unFoldedLabel="@string/TEXT_TO_DISPLAY_WHEN_UNFOLDED">
 * <include layout="@layout/ELEMENTS_TO_BE_FOLDED"/>
 * </com.tiscali.appmail.view.FoldableLinearLayout>
 */
public class FoldableLinearLayout extends LinearLayout {
    ...
    private void processAttributes(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a =
                    context.obtainStyledAttributes(attrs, R.styleable.FoldableLinearLayout, 0, 0);
    ...
    private void initialiseInnerViews() {
        ...
        LinearLayout foldableControl =
                (LinearLayout) mFoldableLayout.findViewById(R.id.foldableControl);
            ...
            if (animate) {
                ...
                animation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        /*
                         * Make sure that at the end the container is completely invisible. GONE is
                         * not used in order to prevent parent views from jumping around as they
                         * re-center themselves vertically.
                         */
