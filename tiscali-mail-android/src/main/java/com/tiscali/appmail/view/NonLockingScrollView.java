 ...
 *
 * Usually ScrollView will capture all touch events once a drag has begun. In some cases, we want to
 * delegate those touches to children as normal, even in the middle of a drag. This is useful when
 * there are childviews like a WebView tha handles scrolling in the horizontal direction even while
 * the ScrollView drags vertically.
 *
...
public class NonLockingScrollView extends ScrollView {
    ...
    /**
     * Traverses the view tree for {@link WebView}s so they can be excluded from touch interceptions
    ...
    public void requestChildFocus(View child, View focused) {
        /*
         * Normally a ScrollView will scroll the child into view. Prevent this when a MessageWebView
         * is first touched, assuming it already is at least partially in view.
         * 
         */
