...
public class MessageWebView extends RigidWebView {
     ...
     * 
     * @param shouldBlockNetworkData True if network data should be blocked, false to allow network
     *        data.
     */
    public void blockNetworkData(final boolean shouldBlockNetworkData) {
         ...
         * Block network loads.
         *
         * Images with content: URIs will not be blocked, nor will network images that are already
         * in the WebView cache.
         *
         */
     ...
     * preferences when configuring the view. This message is used to view a message and to display
     * a message being replied to.
     */
    public void configure() {
        ...
        /*
         * TODO this might improve rendering smoothness when webview is animated into view if
         * (VERSION.SDK_INT >= VERSION_CODES.M) { webSettings.setOffscreenPreRaster(true); }
         */
    ...
    private void disableDisplayZoomControls() {
        ...
        boolean supportsMultiTouch =
                pm.hasSystemFeature(PackageManager.FEATURE_TOUCHSCREEN_MULTITOUCH) || pm
                        .hasSystemFeature(PackageManager.FEATURE_FAKETOUCH_MULTITOUCH_DISTINCT);
    ...
    /*
     * Emulate the shift key being pressed to trigger the text selection mode of a WebView.
     */
