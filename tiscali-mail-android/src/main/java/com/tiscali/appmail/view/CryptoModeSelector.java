...
public class CryptoModeSelector extends FrameLayout implements OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        crossfadedColor = crossfadeColor(grey,
                ThemeUtils.getStyledColor(getContext(), R.attr.openpgp_dark_grey), crossfadeValue1);
        modeIcon1.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey,
                ThemeUtils.getStyledColor(getContext(), R.attr.openpgp_blue), crossfadeValue2);
        modeIcon2.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey,
                ThemeUtils.getStyledColor(getContext(), R.attr.openpgp_orange), crossfadeValue3);
        modeIcon3.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey,
                ThemeUtils.getStyledColor(getContext(), R.attr.openpgp_green), crossfadeValue4);
    ...
    private void animateSnapTo(int value) {
        ...
        currentSeekbarAnim =
                ObjectAnimator.ofInt(seekbar, "progress", seekbar.getProgress(), value);
