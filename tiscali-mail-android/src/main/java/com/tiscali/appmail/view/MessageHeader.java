...
import com.tiscali.appmail.ui.messageview.OnCryptoClickListener;
...
public class MessageHeader extends LinearLayout implements OnClickListener, OnLongClickListener {
    ...
    /**
     * Pair class is only available since API Level 5, so we need this helper class unfortunately
     */
    ...
    public String createMessage(int addressesCount) {
        return mContext.getResources().getQuantityString(R.plurals.copy_address_to_clipboard,
                addressesCount);
    }
    ...
    /**
     * Clear the text field for the additional headers display if they are not shown, to save UI
     * resources.
     */
    ...
    public void populate(final Message message, final Account account) {
        ...
        final CharSequence cc =
                MessageHelper.toFriendly(message.getRecipients(Message.RecipientType.CC), contacts);
        ...
        /*
         * We hide the subject by default for each new message, and MessageTitleView might show it
         * later by calling showSubjectLine().
         */
        ...
        String dateTime = DateUtils.formatDateTime(mContext, message.getSentDate().getTime(),
