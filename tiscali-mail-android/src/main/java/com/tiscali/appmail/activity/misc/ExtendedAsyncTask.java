 ...
 * </p>
 * <p>
 * <strong>Note:</strong> Implementing classes need to make sure they have no reference to the
 * {@code Activity} instance that created the instance of that class. So if it's implemented as
 * inner class, it needs to be {@code static}.
 * </p>
 *
...
public abstract class ExtendedAsyncTask<Params, Progress, Result>
    ...
    /**
     * Connect this {@link AsyncTask} to a new {@link Activity} instance after the activity was
     ...
     * We also have to destroy the progress dialog because it's bound to the activity that's being
     * destroyed.
     * </p>
     *
     ...
     *
     * <p>
     * This needs to store a {@code ProgressDialog} instance in {@link #mProgressDialog} or override
     * {@link #removeProgressDialog()}.
     * </p>
     */
     ...
     *
     * <p>
     * <strong>Important:</strong> Be sure to call {@link #removeProgressDialog()} in
