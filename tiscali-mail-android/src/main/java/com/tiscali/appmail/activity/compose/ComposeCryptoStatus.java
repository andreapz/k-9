...
import com.tiscali.appmail.activity.compose.RecipientMvpView.CryptoStatusDisplayType;
...
/**
 * This is an immutable object which contains all relevant metadata entered during e-mail
 * composition to apply cryptographic operations before sending or saving as draft.
 */
public class ComposeCryptoStatus {
    ...
    public static class ComposeCryptoStatusBuilder {
        ...
        public ComposeCryptoStatusBuilder setCryptoProviderState(
                CryptoProviderState cryptoProviderState) {
    ...
    public SendErrorState getSendErrorStateOrNull() {
        ...
        boolean isPrivateModeAndNotAllKeysAvailable =
                cryptoMode == CryptoMode.PRIVATE && !allKeysAvailable;
