...
class AuthTypeAdapter extends ArrayAdapter<AuthTypeHolder> {
    ...
    public static AuthTypeAdapter get(Context context) {
        AuthType[] authTypes =
                new AuthType[] {AuthType.PLAIN, AuthType.CRAM_MD5, AuthType.EXTERNAL};
        ...
        AuthTypeAdapter authTypesAdapter =
                new AuthTypeAdapter(context, android.R.layout.simple_spinner_item, holders);
        authTypesAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        return authTypesAdapter;
    }

    /**
     * Used to select an appropriate localized text label for the {@code AuthType.PLAIN} option
     * presented to users.
     *
     * @param insecure
     *        <p>
