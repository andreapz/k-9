...
import com.tiscali.appmail.notification.NotificationActionService;
...
public class NotificationDeleteConfirmation extends Activity {
    ...
    private void extractExtras() {
        ...
        ArrayList<MessageReference> messagesToDelete =
        ...
        if (account == null) {
            throw new IllegalStateException(
                    EXTRA_ACCOUNT_UUID + " couldn't be resolved to an account");
        }
    ...
    private Dialog createDeleteConfirmationDialog(int dialogId) {
        return ConfirmationDialog.create(this, dialogId, R.string.dialog_confirm_delete_title, "",
    ...
    private void triggerDelete() {
        ...
        Intent intent = NotificationActionService.createDeleteAllMessagesIntent(this, accountUuid,
                messagesToDelete);
        startService(intent);
    }
}
