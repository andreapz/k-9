...
public class MessageActions {
    /**
     * Compose a new message using the given account. If account is null the default account will be
     * used.
     */
    ...
    public static Intent getActionReplyIntent(Context context, MessageReference messageReference,
            boolean replyAll, Parcelable decryptionResult) {
        Intent i = new Intent(context, MessageCompose.class);
    ...
    /**
     * Compose a new message as a reply to the given message. If replyAll is true the function is
     * reply all instead of simply reply.
     */
    public static void actionReply(Context context, MessageReference messageReference,
            boolean replyAll, Parcelable decryptionResult) {
        context.startActivity(
                getActionReplyIntent(context, messageReference, replyAll, decryptionResult));
    }

    /**
     * Compose a new message as a forward of the given message.
     */
    public static void actionForward(Context context, MessageReference messageReference,
    ...
    /**
     * Continue composition of the given message. This action modifies the way this Activity handles
     * certain actions. Save will attempt to replace the message in the given folder with the
     * updated version. Discard will delete the message from the given folder.
     */
