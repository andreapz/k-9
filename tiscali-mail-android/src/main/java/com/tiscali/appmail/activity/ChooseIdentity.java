...
public class ChooseIdentity extends K9ListActivity {
    ...
    public static final String EXTRA_ACCOUNT = "com.tiscali.appmail.ChooseIdentity_account";
    public static final String EXTRA_IDENTITY = "com.tiscali.appmail.ChooseIdentity_identity";
    ...
    protected void refreshView() {
        ...
        for (Identity identity : identities) {
            ...
            if (description == null || description.trim().isEmpty()) {
                description = getString(R.string.message_view_from_format, identity.getName(),
                        identity.getEmail());
            }
