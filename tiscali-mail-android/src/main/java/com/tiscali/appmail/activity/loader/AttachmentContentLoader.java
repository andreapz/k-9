package com.tiscali.appmail.activity.loader;
    ...
    public AttachmentContentLoader(Context context, Attachment attachment) {
        ...
        if (attachment.state != LoadingState.METADATA) {
            throw new IllegalArgumentException(
                    "Attachment provided to content loader must be in METADATA state");
        }
    ...
    public Attachment loadInBackground() {
        ...
        try {
            ...
            SafeContentResolver safeContentResolver =
                    SafeContentResolverCompat.newInstance(context);
            ...
            cachedResultAttachment =
                    sourceAttachment.deriveWithLoadComplete(file.getAbsolutePath());
