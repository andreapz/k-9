...
public class MessageReference implements Parcelable {
    ...
    public MessageReference(final String identity) throws MessagingException {
        ...
        if (identity.charAt(0) == IDENTITY_VERSION_1.charAt(0)) {
            // Split the identity, stripping away the first two characters representing the version
            // and delimiter.
            StringTokenizer tokens =
                    new StringTokenizer(identity.substring(2), IDENTITY_SEPARATOR, false);
            if (tokens.countTokens() >= 3) {
                ...
                if (tokens.hasMoreTokens()) {
                    ...
                    try {
                        ...
                        throw new MessagingException(
                                "Could not thaw message flag '" + flagString + "'", ie);
                    }
                }
                ...
                throw new MessagingException(
                        "Invalid MessageReference in " + identity + " identity.");
            }
        }
        this.accountUuid = accountUuid;
        this.folderName = folderName;
    ...
    /**
     * Serialize this MessageReference for storing in a K9 identity. This is a colon-delimited
     * base64 string.
     *
    ...
    public boolean equals(String accountUuid, String folderName, String uid) {
        ...
        return ((accountUuid == this.accountUuid
                || (accountUuid != null && accountUuid.equals(this.accountUuid)))
                && (folderName == this.folderName
                        || (folderName != null && folderName.equals(this.folderName)))
    ...
    public String toString() {
        return "MessageReference{" + "accountUuid='" + accountUuid + '\'' + ", folderName='"
                + folderName + '\'' + ", uid='" + uid + '\'' + ", flag=" + flag + '}';
    }
        ...
        try {
            ...
            if (account != null) {
                ...
                if (folder != null) {
                    ...
                    Log.d(K9.LOG_TAG,
                            "Could not restore message, folder " + folderName + " is unknown.");
                }
            } else {
                Log.d(K9.LOG_TAG,
                        "Could not restore message, account " + accountUuid + " is unknown.");
            }
