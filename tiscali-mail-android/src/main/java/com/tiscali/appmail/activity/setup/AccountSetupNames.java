...
public class AccountSetupNames extends K9Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * Since this field is considered optional, we don't set this here. If the user fills in a
         * value we'll reset the current value, otherwise we just leave the saved value alone.
         */
    ...
    protected void onNext() {
        ...
        NavigationDrawerActivity.listMessage(this, mAccount.getUuid());
