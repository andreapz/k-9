...
public class AccountSetupBasics extends K9Activity implements OnClickListener, TextWatcher,
    ...
    private final static String EXTRA_ACCOUNT = "com.tiscali.appmail.AccountSetupBasics.account";
    private final static int DIALOG_NOTE = 1;
    private final static String STATE_KEY_PROVIDER =
            "com.tiscali.appmail.AccountSetupBasics.provider";
    private final static String STATE_KEY_CHECKED_INCOMING =
            "com.tiscali.appmail.AccountSetupBasics.checkedIncoming";
