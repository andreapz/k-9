...
import com.tiscali.appmail.mail.store.imap.ImapStoreSettings;
import com.tiscali.appmail.mail.store.webdav.WebDavStoreSettings;
import com.tiscali.appmail.service.MailService;
import com.tiscali.appmail.view.ClientCertificateSpinner;
import com.tiscali.appmail.view.ClientCertificateSpinner.OnClientCertificateChangedListener;
...
public class AccountSetupIncoming extends K9Activity implements OnClickListener {
    ...
    public static void actionIncomingSettings(Activity context, Account account,
            boolean makeDefault) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mClientCertificateLabelView =
                (TextView) findViewById(R.id.account_client_certificate_label);
        ...
        try {
            ...
            if (Type.POP3 == settings.type) {
                ...
                mConnectionSecurityChoices = new ConnectionSecurity[] {ConnectionSecurity.NONE,
            ...
            if (savedInstanceState == null) {
                mCurrentSecurityTypeViewPosition = securityTypesAdapter
                        .getConnectionSecurityPosition(settings.connectionSecurity);
            } else {

                /*
                 * Restore the spinner state now, before calling setOnItemSelectedListener(), thus
                 * avoiding a call to onItemSelected(). Then, when the system restores the state
                 * (again) in onRestoreInstanceState(), The system will see that the new state is
                 * the same as the current state (set here), so once again onItemSelected() will not
                 * be called.
                 */
                mCurrentSecurityTypeViewPosition =
                        savedInstanceState.getInt(STATE_SECURITY_TYPE_POSITION);
            }
    ...
    private void initializeViewListeners() {
        ...
        /*
         * Updates the port when the user changes the security type. This allows us to show a
         * reasonable default which the user can change.
         */
        mSecurityTypeView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*
                 * We keep our own record of the spinner state so we know for sure that
                 * onItemSelected() was called because of user input, not because of spinner state
                 * initialization. This assures that the port will not be replaced with a default
                 * value except on user input.
                 */
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        /*
         * We didn't want the listeners active while the state was being restored because they could
         * overwrite the restored port with a default port when the security type was restored.
         */
     ...
     * programmatically. (The logic is simpler when you know that this is the last thing called
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText =
                    getString(R.string.account_setup_incoming_invalid_setting_combo_notice,
            ...
            OnItemSelectedListener onItemSelectedListener =
                    mAuthTypeView.getOnItemSelectedListener();
        ...
        boolean hasValidPasswordSettings = hasValidUserName && !isAuthTypeExternal
                && Utility.requiredFieldValid(mPasswordView);

        boolean hasValidExternalAuthSettings = hasValidUserName && isAuthTypeExternal
                && hasConnectionSecurity && hasValidCertificateAlias;
        ...
        if (resultCode == RESULT_OK) {
            if (Intent.ACTION_EDIT.equals(getIntent().getAction())) {
                ...
                try {
                    ...
                    ServerSettings transportServer = new ServerSettings(Type.SMTP, oldUri.getHost(),
                            oldUri.getPort(), ConnectionSecurity.SSL_TLS_REQUIRED, authType,
    ...
    protected void onNext() {
        try {
            ...
            ServerSettings settings = new ServerSettings(mStoreType, host, port, connectionSecurity,
                    authType, username, password, clientCertificateAlias, extra);
    ...
    OnClientCertificateChangedListener clientCertificateChangedListener =
    ...
    private ConnectionSecurity getSelectedSecurity() {
        ConnectionSecurityHolder holder =
                (ConnectionSecurityHolder) mSecurityTypeView.getSelectedItem();
