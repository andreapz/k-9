...
public class AccountSetupComposition extends K9Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            ...
                            boolean isSignatureBeforeQuotedText =
                                    mAccount.isSignatureBeforeQuotedText();
        ...
        mAccountSignatureBeforeLocation =
                (RadioButton) findViewById(R.id.account_signature_location_before_quoted_text);
        mAccountSignatureAfterLocation =
                (RadioButton) findViewById(R.id.account_signature_location_after_quoted_text);
