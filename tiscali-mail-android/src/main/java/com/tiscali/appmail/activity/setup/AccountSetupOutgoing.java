...
public class AccountSetupOutgoing extends K9Activity
        ...
        mSecurityTypeView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mCurrentSecurityTypeViewPosition != position) {
                    ...
                    /*
                     * If the user selects ConnectionSecurity.NONE, a warning would normally pop up
                     * if the authentication is AuthType.EXTERNAL (i.e., using client certificates).
                     * But such a warning is irrelevant if login is not required. So to avoid such a
                     * warning (generated in validateFields()) under those conditions, we change the
                    ...
                    if (isInsecure && isAuthExternal && loginNotRequired) {
                        ...
                        mCurrentAuthTypeViewPosition =
                                mAuthTypeAdapter.getAuthPosition(AuthType.PLAIN);
                        mAuthTypeView.setSelection(mCurrentAuthTypeViewPosition, false);
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText =
                    getString(R.string.account_setup_outgoing_invalid_setting_combo_notice,
