...
import com.tiscali.appmail.view.CryptoModeSelector;
import com.tiscali.appmail.view.CryptoModeSelector.CryptoStatusSelectedListener;
import com.tiscali.appmail.view.LinearViewAnimator;
...
public class CryptoSettingsDialog extends DialogFragment implements CryptoStatusSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view =
                LayoutInflater.from(getActivity()).inflate(R.layout.crypto_settings_dialog, null);
    ...
    private void changeCryptoSettings() {
        ...
        boolean activityIsCryptoModeChangedListener =
                activity instanceof OnCryptoModeChangedListener;
        if (!activityIsCryptoModeChangedListener) {
            throw new AssertionError(
                    "This dialog must be called by an OnCryptoModeChangedListener!");
        }
