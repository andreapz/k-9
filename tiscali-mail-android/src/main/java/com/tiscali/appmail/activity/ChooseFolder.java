...
public class ChooseFolder extends K9ListActivity {
    public static final String EXTRA_ACCOUNT = "com.tiscali.appmail.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.tiscali.appmail.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.tiscali.appmail.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.tiscali.appmail.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.tiscali.appmail.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.tiscali.appmail.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE =
            "com.tiscali.appmail.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY =
            "com.tiscali.appmail.ChooseFolder_showDisplayableOnly";
    ...
    private MessagingListener mListener = new MessagingListener() {
        ...
        public void listFolders(Account account, List<LocalFolder> folders) {
            ...
            List<String> localFolders = new ArrayList<String>(
                    newFolders.size() + topFolders.size() + ((mShowOptionNone) ? 1 : 0));
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        // Now we're in the UI-thread, we can safely change the contents of the
                        // adapter.
                        mAdapter.clear();
                        ...
                        /*
                         * Only enable the text filter after the list has been populated to avoid
                         * possible race conditions because our FolderListFilter isn't really
                         * thread-safe.
                         */
