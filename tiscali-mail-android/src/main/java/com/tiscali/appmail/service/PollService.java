...
public class PollService extends CoreService {
    private static String START_SERVICE = "com.tiscali.appmail.service.PollService.startService";
    private static String STOP_SERVICE = "com.tiscali.appmail.service.PollService.stopService";
    ...
    class Listener extends MessagingListener {
        ...
        // wakelock strategy is to be very conservative. If there is any reason to release, then
        // release
        ...
        public synchronized void wakeLockAcquire() {
            ...
            wakeLock =
                    pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "PollService wakeLockAcquire");
