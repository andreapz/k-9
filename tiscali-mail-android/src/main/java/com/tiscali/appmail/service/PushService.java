...
public class PushService extends CoreService {
    private static String START_SERVICE = "com.tiscali.appmail.service.PushService.startService";
    private static String STOP_SERVICE = "com.tiscali.appmail.service.PushService.stopService";
