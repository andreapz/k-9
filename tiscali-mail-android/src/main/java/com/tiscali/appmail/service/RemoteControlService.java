...
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_ACCOUNT_UUID;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_ALL_ACCOUNTS;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_BACKGROUND_OPERATIONS;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_NOTIFICATION_ENABLED;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_POLL_CLASSES;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_POLL_FREQUENCY;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_PUSH_CLASSES;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_RING_ENABLED;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_THEME;
import static com.tiscali.appmail.remotecontrol.K9RemoteControl.K9_VIBRATE_ENABLED;
...
import com.tiscali.appmail.K9.BACKGROUND_OPS;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION =
            "com.tiscali.appmail.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION =
            "com.tiscali.appmail.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION =
            "com.tiscali.appmail.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        for (Account account : accounts) {
                            ...
                            if (allAccounts || account.getUuid().equals(uuid)) {
                                ...
                                String notificationEnabled =
                                        intent.getStringExtra(K9_NOTIFICATION_ENABLED);
                                ...
                                if (notificationEnabled != null) {
                                    account.setNotifyNewMail(
                                            Boolean.parseBoolean(notificationEnabled));
                                }
                                if (ringEnabled != null) {
                                    account.getNotificationSetting()
                                            .setRing(Boolean.parseBoolean(ringEnabled));
                                }
                                if (vibrateEnabled != null) {
                                    account.getNotificationSetting()
                                            .setVibrate(Boolean.parseBoolean(vibrateEnabled));
                                }
                                if (pushClasses != null) {
                                    needsPushRestart |= account
                                            .setFolderPushMode(FolderMode.valueOf(pushClasses));
                                }
                                if (pollClasses != null) {
                                    needsReschedule |= account
                                            .setFolderSyncMode(FolderMode.valueOf(pollClasses));
                                }
                        ...
                        if (theme != null) {
                            K9.setK9Theme(K9RemoteControl.K9_THEME_DARK.equals(theme)
                                    ? K9.Theme.DARK : K9.Theme.LIGHT);
                        }
                        ...
                        Toast toast = Toast.makeText(RemoteControlService.this, e.getMessage(),
                                Toast.LENGTH_LONG);
                        toast.show();
                    }
                }
