...
public class QuotedMessageMvpView {
    ...
    public QuotedMessageMvpView(MessageCompose messageCompose) {
        ...
        // Disable the ability to click links in the quoted HTML page. I think this is a nice
        // feature, but if someone
        // feels this should be a preference (or should go away all together), I'm ok with that too.
        // -achen 20101130
        ...
        mMessageContentView =
                (EolConvertingEditText) messageCompose.findViewById(R.id.message_content);
    }
