...
import com.tiscali.appmail.helper.ClipboardManager;
...
import com.tiscali.appmail.view.MessageHeader.OnLayoutChangedListener;
import com.tiscali.appmail.view.MessageWebView;
import com.tiscali.appmail.view.MessageWebView.OnPageFinishedListener;
...
public class MessageContainerView extends LinearLayout
        implements OnLayoutChangedListener, OnCreateContextMenuListener {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        switch (type) {
            ...
            case HitTestResult.SRC_IMAGE_ANCHOR_TYPE: {
                ...
                menu.setHeaderTitle((externalImage) ? url
                        : context.getString(R.string.webview_contextmenu_image_title));
    ...
    public void displayMessageViewContainer(MessageViewInfo messageViewInfo,
            ...
            boolean automaticallyLoadPictures, AttachmentViewCallback attachmentCallback) {
        ...
        if (textToDisplay == null) {
            textToDisplay = HtmlConverter
                    .wrapStatusMessage(getContext().getString(R.string.webview_empty_message));
        }
    ...
    private void displayHtmlContentWithInlineAttachments(String htmlText,
            AttachmentResolver attachmentResolver, OnPageFinishedListener onPageFinishedListener) {
    ...
    private void refreshDisplayedContent() {
        mMessageContentView.displayHtmlContentWithInlineAttachments(currentHtmlText,
    ...
    public void renderAttachments(MessageViewInfo messageViewInfo) {
        ...
        if (messageViewInfo.attachments != null) {
            for (AttachmentViewInfo attachment : messageViewInfo.attachments) {
                AttachmentView view = (AttachmentView) mInflater
                        .inflate(R.layout.message_view_attachment, mAttachments, false);
    ...
    public void resetView() {
         ...
         * its size because the button to download the complete message was previously shown and is
         * now hidden.
         */
