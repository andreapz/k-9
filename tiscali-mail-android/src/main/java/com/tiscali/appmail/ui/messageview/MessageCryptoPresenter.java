...
public class MessageCryptoPresenter implements OnCryptoClickListener {
    ...
    public MessageCryptoPresenter(Bundle savedInstanceState,
    ...
    public boolean maybeHandleShowMessage(MessageTopView messageView, Account account,
            MessageViewInfo messageViewInfo) {
        this.cryptoResultAnnotation = messageViewInfo.cryptoResultAnnotation;

        MessageCryptoDisplayStatus displayStatus = MessageCryptoDisplayStatus
                .fromResultAnnotation(messageViewInfo.cryptoResultAnnotation);
        ...
        switch (displayStatus) {
            ...
            case CANCELLED: {
                Drawable providerIcon =
                        getOpenPgpApiProviderIcon(messageView.getContext(), account);
    ...
    public interface MessageCryptoMvpView {
        ...
        void startPendingIntentForCryptoPresenter(IntentSender si, Integer requestCode,
