...
public class MessageCryptoSplitter {
    ...
    @Nullable
    public static CryptoMessageParts split(@NonNull Message message,
        ...
        Part primaryPart =
                MessageDecryptVerifier.findPrimaryEncryptedOrSignedPart(message, extraParts);
    ...
    public static class CryptoMessageParts {
        ...
        CryptoMessageParts(Part contentPart, CryptoResultAnnotation contentCryptoAnnotation,
