...
import com.tiscali.appmail.provider.AttachmentProvider.AttachmentProviderColumns;
...
class DownloadImageTask extends AsyncTask<String, Void, String> {
    private static final String[] ATTACHMENT_PROJECTION =
            new String[] {AttachmentProviderColumns._ID, AttachmentProviderColumns.DISPLAY_NAME};
