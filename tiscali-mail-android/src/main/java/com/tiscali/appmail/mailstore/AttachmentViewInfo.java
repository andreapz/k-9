...
public class AttachmentViewInfo {
     ...
     * <p/>
     * Note: All content providers must support an alternative MIME type appended as last URI
     * segment.
     *
     * @see com.tiscali.appmail.ui.messageview.AttachmentController#getAttachmentUriForMimeType(AttachmentViewInfo,
     *      String)
     */
    ...
    public AttachmentViewInfo(String mimeType, String displayName, long size, Uri uri,
            boolean inlineAttachment, Part part, boolean isContentAvailable) {
