...
import com.tiscali.appmail.mailstore.util.DeferredFileOutputStream;
...
/**
 * This is a body where the data is memory-backed at first and switches to file-backed if it gets
 * larger.
 * 
 * @see FileFactory
 */
public class DeferredFileBody implements RawDataBody, SizeAware {
    ...
    @VisibleForTesting
    DeferredFileBody(int memoryBackedThreshold, FileFactory fileFactory, String transferEncoding) {
