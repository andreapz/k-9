...
/**
 * Filter to search for occurences of the search-expression in any place of the folder-name instead
 * of doing jsut a prefix-search.
 *
 * @author Marcus@Wolschon.biz
 */
public class FolderListFilter<T> extends Filter {
    /**
     * ArrayAdapter that contains the list of folders displayed in the ListView. This object is
     * modified by {@link #publishResults} to reflect the changes due to the filtering performed by
     * {@link #performFiltering}. This in turn will change the folders displayed in the ListView.
     */
