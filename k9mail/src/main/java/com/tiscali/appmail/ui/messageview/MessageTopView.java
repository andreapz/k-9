...
import com.tiscali.appmail.ui.messageview.MessageContainerView.OnRenderingFinishedListener;
import com.tiscali.appmail.view.MessageHeader;
import com.tiscali.appmail.view.ThemeUtils;
import com.tiscali.appmail.view.ToolableViewAnimator;
...
public class MessageTopView extends LinearLayout {
    ...
    public void showMessage(Account account, MessageViewInfo messageViewInfo) {
        ...
        MessageContainerView view = (MessageContainerView) mInflater
                .inflate(R.layout.message_container, containerView, false);
    ...
    public void showMessageCryptoWarning(final MessageViewInfo messageViewInfo,
            Drawable providerIcon, @StringRes int warningTextRes) {
        resetAndPrepareMessageView(messageViewInfo);
        View view =
                mInflater.inflate(R.layout.message_content_crypto_warning, containerView, false);
    ...
    public void showMessageEncryptedButIncomplete(MessageViewInfo messageViewInfo,
        ...
        resetAndPrepareMessageView(messageViewInfo);
        View view =
                mInflater.inflate(R.layout.message_content_crypto_incomplete, containerView, false);
        setCryptoProviderIcon(providerIcon, view);
    ...
    public void showMessageCryptoCancelledView(MessageViewInfo messageViewInfo,
        ...
        resetAndPrepareMessageView(messageViewInfo);
        View view =
                mInflater.inflate(R.layout.message_content_crypto_cancelled, containerView, false);
        setCryptoProviderIcon(providerIcon, view);
    ...
    private void setCryptoProviderIcon(Drawable openPgpApiProviderIcon, View view) {
        ...
        if (openPgpApiProviderIcon != null) {
            ...
            cryptoProviderIcon
                    .setColorFilter(ThemeUtils.getStyledColor(getContext(), R.attr.openpgp_red));
        }
    }

    /**
     * Fetch the message header view. This is not the same as the message headers; this is the View
     * shown at the top of messages.
     * 
    ...
    private boolean shouldAutomaticallyLoadPictures(ShowPictures showPicturesSetting,
            Message message) {
    ...
    public void displayViewOnLoadFinished(boolean finishProgressBar) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofInt(progressBar, "progress",
                progressBar.getProgress(), PROGRESS_MAX);
