...
public class MessagingListener {
    ...
    /**
     * Called when a new result message is available for a remote search Can assume headers have
     * been downloaded, but potentially not body.
     * 
     * @param folder
     * @param message
     */
    ...
    /**
     * General notification messages subclasses can override to be notified that the controller has
     * completed a command. This is useful for turning off progress indicators that may have been
     * left over from previous commands.
     *
     * @param moreCommandsToRun {@code true} if the controller will continue on to another command
