 ...
 * {@link com.tiscali.appmail.activity.MessageList} action bar. It will hide the subject line in
 * {@link MessageHeader} if the subject fits completely into the action bar's title view.
 */
public class MessageTitleView extends TextView {
    ...
    public void onDraw(Canvas canvas) {
        /*
         * Android does not support ellipsize in combination with maxlines for TextViews. To work
         * around that, check for ourselves whether the text is longer than MAX_LINES, and ellipsize
         * manually.
         */
