...
public class HighlightDialogFragment extends DialogFragment {
    ...
    protected void highlightViewInBackground() {
        ...
        showcaseView = new Builder(activity).setTarget(new ViewTarget(highlightedView, activity))
                .hideOnTouchOutside().blockAllTouches().withMaterialShowcase()
                .setStyle(R.style.ShowcaseTheme).build();
