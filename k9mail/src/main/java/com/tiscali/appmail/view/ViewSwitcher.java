...
/**
 * A {@link ViewAnimator} that animates between two child views using different animations depending
 * on which view is displayed.
 */
public class ViewSwitcher extends ViewAnimator implements AnimationListener {
    ...
    public interface OnSwitchCompleteListener {
         ...
         *
         * @param displayedChild Contains the zero-based index of the child view that is now
         *        displayed.
         */
