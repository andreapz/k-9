        ...
        return new ListView(context, attrs) {
            ...
            protected void dispatchDraw(Canvas canvas) {
                if (getAdapter() != null) {
                     ...
                     * framework code. I didn't track down the exact cause of this. My best guess is
                     * that we change the data (remove items) while the ListView isn't visible.
                     * Probably because the view is hidden, layoutChildren() is never called and
                     * when this method runs the layout contains more item views than the adapter
                     * contains elements and bad things(tm) happen.
                     */
                    if (itemCount < count) {
                        layoutChildren();
                    }
