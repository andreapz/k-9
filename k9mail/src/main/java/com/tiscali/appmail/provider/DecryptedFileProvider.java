...
public class DecryptedFileProvider extends FileProvider {
    ...
    public static Uri getUriForProvidedFile(@NonNull Context context, File file,
        ...
        try {
            Uri.Builder uriBuilder =
                    FileProvider.getUriForFile(context, AUTHORITY, file).buildUpon();
            if (mimeType != null) {
        ...
        for (File tempFile : tempDirectory.listFiles()) {
            ...
            if (lastModified < deletionThreshold) {
                ...
                if (K9.DEBUG) {
                    ...
                    Log.e(K9.LOG_TAG,
                            "Not deleting temp file (for another " + timeLeftStr + " minutes)");
                }
                allFilesDeleted = false;
            }
        }
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        try {
            ...
            // not strictly a FileNotFoundException, but failure to create a pipe is basically
        ...
        public void onReceive(Context context, Intent intent) {
            if (!Intent.ACTION_SCREEN_OFF.equals(intent.getAction())) {
                throw new IllegalArgumentException(
                        "onReceive called with action that isn't screen off!");
            }
