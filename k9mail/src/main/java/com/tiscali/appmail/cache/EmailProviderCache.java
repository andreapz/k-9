package com.tiscali.appmail.cache;
...
public class EmailProviderCache {
    ...
    private final Map<Long, Map<String, String>> mMessageCache =
            new HashMap<Long, Map<String, String>>();
    private final Map<Long, Map<String, String>> mThreadCache =
            new HashMap<Long, Map<String, String>>();
     ...
     *
     * <p>
     * <strong>Note:</strong> Notifying the content resolver of the change will cause the
     * {@code CursorLoader} in {@link MessageListFragment} to reload the cursor. But especially with
     * flag changes this will block because of the DB write operation to update the flags. So
     * additionally we use {@link LocalBroadcastManager} to send a {@link #ACTION_CACHE_UPDATED}
     * broadcast. This way {@code MessageListFragment} can update the view without reloading the
     * cursor.
     * </p>
     */
