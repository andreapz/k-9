...
public interface SearchSpecification extends Parcelable {
    ...
    ///////////////////////////////////////////////////////////////
    /*
     * Using an enum in order to have more robust code. Users ( & coders ) are prevented from
     * passing illegal fields. No database overhead when invalid fields passed.
     *
     * By result, only the fields in here are searchable.
     *
     * Fields not in here at this moment ( and by effect not searchable ): id, html_content,
    ...
    ///////////////////////////////////////////////////////////////
    /**
     * This class represents 1 value for a certain search field. One value consists of three things:
     * an attribute: equals, starts with, contains,... a searchfield: date, flags, sender,
     * subject,... a value: "apple", "jesse",..
     *
     * @author dzan
     */
    public class SearchCondition implements Parcelable {
        ...
        public boolean equals(Object o) {
            if (o instanceof SearchCondition) {
                ...
                if (tmp.attribute == attribute && tmp.field == field && tmp.value.equals(value)) {
                    return true;
                }
            }
