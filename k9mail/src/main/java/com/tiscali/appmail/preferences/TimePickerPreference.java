/*
 * Sourced from http://www.ebessette.com/d/TimePickerPreference on 2010-11-27 by jessev
 */
...
public class TimePickerPreference extends DialogPreference
    ...
    /**
     * Store the original value, in case the user chooses to abort the {@link DialogPreference}
    ...
    public void setDefaultValue(final Object defaultValue) {
        // BUG this method is never called if you use the 'android:defaultValue' attribute in your
        // XML preference file, not sure why it isn't
    ...
    /**
     * Get the time. It is only legal, if it matches {@link #VALIDATION_EXPRESSION}.
     *
