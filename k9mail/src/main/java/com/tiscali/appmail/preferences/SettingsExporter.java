...
public class SettingsExporter {
    ...
    private static void writeSettings(XmlSerializer serializer, Map<String, Object> prefs)
            throws IOException {
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(K9.LOG_TAG,
                                "Account setting \"" + keyPart + "\" (" + account.getDescription()
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(K9.LOG_TAG,
                                "Identity setting \"" + identityKey + "\" has invalid value \""
                                        + valueString
                                        + "\" in preference storage. This shouldn't happen!");
                    }
                }
    ...
    private static void writeFolder(XmlSerializer serializer, String accountUuid, String folder,
        ...
        for (Map.Entry<String, Object> entry : prefs.entrySet()) {
            ...
            if (indexOfFirstDot == -1 || indexOfLastDot == -1
                    || indexOfFirstDot == indexOfLastDot) {
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(K9.LOG_TAG,
                                "Folder setting \"" + folderKey + "\" has invalid value \""
                                        + valueString
                                        + "\" in preference storage. This shouldn't happen!");
                    }
                }
