...
import com.tiscali.appmail.preferences.GlobalSettings;
...
/**
 * Manage font size of the information displayed in the account list, folder list, message list and
 * in the message view.
 */
public class FontSizes {
    ...
    private static final String MESSAGE_VIEW_ADDITIONAL_HEADERS =
    ...
    public void load(Storage storage) {
        ...
        messageViewAdditionalHeaders =
                storage.getInt(MESSAGE_VIEW_ADDITIONAL_HEADERS, messageViewAdditionalHeaders);
    ...
    // This, arguably, should live somewhere in a view class, but since we call it from activities,
    // fragments
