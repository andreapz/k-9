...
public class ReconstructMessageFromDatabaseTest extends ApplicationTestCase<K9> {
    ...
    public void testThatByteIdenticalCopyOfMessageIsReconstructed()
    ...
    protected void saveMessageToDatabase(LocalFolder folder, MimeMessage message)
            throws MessagingException {
        folder.appendMessages(Collections.singletonList(message));
    }

    protected LocalMessage readMessageFromDatabase(LocalFolder folder, MimeMessage message)
            throws MessagingException {
    ...
    protected String writeMessageToString(LocalMessage localMessage)
            throws IOException, MessagingException {
