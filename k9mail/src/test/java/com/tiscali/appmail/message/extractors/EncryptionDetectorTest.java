...
import static com.tiscali.appmail.message.MessageCreationHelper.createMessage;
import static com.tiscali.appmail.message.MessageCreationHelper.createMultipartMessage;
import static com.tiscali.appmail.message.MessageCreationHelper.createPart;
import static com.tiscali.appmail.message.MessageCreationHelper.createTextMessage;
...
public class EncryptionDetectorTest {
    ...
    @Test
    public void isEncrypted_withMultipartMixedContainingSMimePart_shouldReturnTrue()
            throws Exception {
    ...
    public void isEncrypted_withInlinePgp_shouldReturnTrue() throws Exception {
        Message message = createTextMessage("text/plain", "" + "-----BEGIN PGP MESSAGE-----" + CRLF
                + "some encrypted stuff here" + CRLF + "-----END PGP MESSAGE-----");
    ...
    public void isEncrypted_withPlainTextAndPreambleWithInlinePgp_shouldReturnFalse()
        ...
        Message message = createTextMessage("text/plain",
                "" + "preamble" + CRLF + "-----BEGIN PGP MESSAGE-----" + CRLF
                        + "some encrypted stuff here" + CRLF + "-----END PGP MESSAGE-----" + CRLF
                        + "epilogue");
        when(textPartFinder.findFirstTextPart(message)).thenReturn(message);
    ...
    public void isEncrypted_withQuotedInlinePgp_shouldReturnFalse() throws Exception {
        Message message = createTextMessage("text/plain",
                "" + "good talk!" + CRLF + CRLF + "> -----BEGIN PGP MESSAGE-----" + CRLF
                        + "> some encrypted stuff here" + CRLF + "> -----END PGP MESSAGE-----"
                        + CRLF + CRLF + "-- " + CRLF + "my signature");
        when(textPartFinder.findFirstTextPart(message)).thenReturn(message);
