...
public class AttachmentResolverTest {
    ...
    public void buildCidMap__onPartWithNoBody__shouldReturnEmptyMap() throws Exception {
        ...
        Map<String, Uri> result =
                AttachmentResolver.buildCidToAttachmentUriMap(attachmentInfoExtractor, part);
    ...
    public void buildCidMap__onMultipartWithNoParts__shouldReturnEmptyMap() throws Exception {
        ...
        Map<String, Uri> result = AttachmentResolver
                .buildCidToAttachmentUriMap(attachmentInfoExtractor, multipartPart);
    ...
    public void buildCidMap__onTwoPart__shouldReturnBothUris() throws Exception {
        ...
        when(attachmentInfoExtractor.extractAttachmentInfo(subPart1))
                .thenReturn(new AttachmentViewInfo(null, null, AttachmentViewInfo.UNKNOWN_SIZE,
                        ATTACHMENT_TEST_URI_1, false, subPart1, true));
        when(attachmentInfoExtractor.extractAttachmentInfo(subPart2))
                .thenReturn(new AttachmentViewInfo(null, null, AttachmentViewInfo.UNKNOWN_SIZE,
                        ATTACHMENT_TEST_URI_2, false, subPart2, true));
