...
import com.tiscali.appmail.GlobalsHelper;
import com.tiscali.appmail.activity.K9ActivityCommon;
import com.tiscali.appmail.helper.HtmlSanitizer;
import com.tiscali.appmail.helper.HtmlSanitizerHelper;
...
import com.tiscali.appmail.mailstore.MessageViewInfoExtractor.ViewableExtractedText;
...
public class MessageViewInfoExtractorTest {
    ...
    public void testShouldSanitizeOutputHtml() throws MessagingException {
        ...
        MessageExtractor.findViewablesAndAttachments(message, outputViewableParts,
    ...
    public void testMultipartPlainTextMessage() throws MessagingException {
        ...
        String expectedText = bodyText1 + "\r\n\r\n"
                + "------------------------------------------------------------------------\r\n\r\n"
                + bodyText2;
        String expectedHtml = "<pre class=\"k9mail\">" + bodyText1 + "</pre>"
                + "<p style=\"margin-top: 2.5em; margin-bottom: 1em; "
                + "border-bottom: 1px solid #000\"></p>" + "<pre class=\"k9mail\">" + bodyText2
                + "</pre>";
