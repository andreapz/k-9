...
public class MessagingControllerTest {
    ...
    @Test
    public void listFoldersSynchronous_shouldNotifyTheListenerListingStarted()
    ...
    @Test
    public void listFoldersSynchronous_shouldNotifyTheListenerOfTheListOfFolders()
            throws MessagingException {
        List<LocalFolder> folders = Collections.singletonList(localFolder);
        when(localStore.getPersonalNamespaces(false)).thenReturn(folders);
    ...
    @Test
    public void listFoldersSynchronous_shouldNotNotifyFinishedAfterFailure()
            throws MessagingException {
        when(localStore.getPersonalNamespaces(false)).thenThrow(new MessagingException("Test"));
    ...
    @Test
    public void listFoldersSynchronous_shouldNotifyFinishedAfterSuccess()
            throws MessagingException {
        List<LocalFolder> folders = Collections.singletonList(localFolder);
        when(localStore.getPersonalNamespaces(false)).thenReturn(folders);
    ...
    @Test
    public void refreshRemoteSynchronous_shouldDeleteFoldersNotOnRemote()
            throws MessagingException {
        configureRemoteStoreWithFolder();
    ...
    @Test
    public void refreshRemoteSynchronous_shouldNotDeleteFoldersOnRemote()
            throws MessagingException {
        configureRemoteStoreWithFolder();
        when(localStore.getPersonalNamespaces(false))
    ...
    @Test
    public void refreshRemoteSynchronous_shouldNotDeleteSpecialFoldersNotOnRemote()
            throws MessagingException {
        configureRemoteStoreWithFolder();
    ...
    @Test
    public void refreshRemoteSynchronous_shouldNotifyFinishedAfterSuccess()
            throws MessagingException {
        configureRemoteStoreWithFolder();
        List<LocalFolder> folders = Collections.singletonList(localFolder);
        when(localStore.getPersonalNamespaces(false)).thenReturn(folders);
    ...
    @Test
    public void refreshRemoteSynchronous_shouldNotNotifyFinishedAfterFailure()
            throws MessagingException {
        configureRemoteStoreWithFolder();
        when(localStore.getPersonalNamespaces(false)).thenThrow(new MessagingException("Test"));
    ...
    @Test
    public void searchLocalMessagesSynchronous_shouldNotifyFailureIfStoreThrowsException()
            throws Exception {
        setAccountsInPreferences(Collections.singletonMap("1", account));
        when(search.getAccountUuids()).thenReturn(new String[] {"allAccounts"});
    ...
    public void searchLocalMessagesSynchronous_shouldNotifyWhenStoreFinishesRetrievingAMessage()
        ...
        verify(listener).listLocalMessagesAddMessages(eq(account), eq((String) null),
                eq(Collections.singletonList(localMessage)));
    }
    ...
    private void setupRemoteSearch() throws Exception {
        ...
        when(localFolder.extractNewMessages(Matchers.<List<Message>>any()))
                .thenReturn(newRemoteMessages);
        when(localFolder.getMessage("newMessageUid1")).thenReturn(localNewMessage1);
        when(localFolder.getMessage("newMessageUid2")).thenAnswer(new Answer<LocalMessage>() {
            @Override
        ...
        doAnswer(new Answer<Void>() {
            ...
            public Void answer(InvocationOnMock invocation) throws Throwable {
                ...
                any(FetchProfile.class), Matchers.<MessageRetrievalListener>eq(null));
    ...
    @Test
    public void searchRemoteMessagesSynchronous_shouldNotifyStartedListingRemoteMessages()
            throws Exception {
        setupRemoteSearch();

        controller.searchRemoteMessagesSynchronous("1", FOLDER_NAME, "query", reqFlags,
    ...
    @Test
    public void searchRemoteMessagesSynchronous_shouldNotifyListenerOfNewMessages()
            throws Exception {
        setupRemoteSearch();
    ...
    public void synchronizeMailboxSynchronous_withAccountSetToSyncRemoteDeletions_shouldDeleteLocalCopiesOfDeletedMessages()
        ...
        when(localFolder.getMessages(null))
    ...
    public void synchronizeMailboxSynchronous_withAccountSetNotToSyncRemoteDeletions_shouldNotDeleteLocalCopiesOfMessages()
        ...
        when(localFolder.getMessages(null))
                .thenReturn(Collections.singletonList(remoteDeletedMessage));
    ...
    private void respondToFetchEnvelopesWithMessage(final Message message)
            throws MessagingException {
        doAnswer(new Answer() {
            @Override
            public Void answer(InvocationOnMock invocation) throws Throwable {
                ...
                if (invocation.getArguments()[2] != null) {
                    MessageRetrievalListener listener =
                            (MessageRetrievalListener) invocation.getArguments()[2];
    ...
    private LocalMessage localMessageWithCopyOnServer() throws MessagingException {
        ...
        when(remoteFolder.getMessages(anyInt(), anyInt(), any(Date.class),
                any(MessageRetrievalListener.class)))
