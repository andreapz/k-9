...
public class UidReverseComparatorTest {
    ...
    public void compare_withNullArgumentAndMessageWithNullUid_shouldReturnZero() throws Exception {
        ...
        assertEquals("result must be 0 when both arguments are not a message with valid UID", 0,
                result);
    }
    ...
    public void compare_withTwoMessagesWithNullUid_shouldReturnZero() throws Exception {
        ...
        assertEquals("result must be 0 when both arguments are a message with a null UID", 0,
                result);
    }
    ...
    public void compare_withTwoMessagesWithInvalidUid_shouldReturnZero() throws Exception {
        ...
        assertEquals("result must be 0 when both arguments are a message with an invalid UID", 0,
                result);
    }
    ...
    public void compare_withRightMessageWithInvalidUid_shouldReturnNegative() throws Exception {
        ...
        assertTrue("result must be < 0 when right argument is message with invalid UID",
                result < 0);
    }
    ...
    public void compare_twoMessages_shouldReturnOrderByUid() throws Exception {
        ...
        assertTrue("result must be > 0 when right message has larger UID than left message",
                resultOne > 0);
        assertTrue("result must be < 0 when left message has larger UID than right message",
                resultTwo < 0);
    }
